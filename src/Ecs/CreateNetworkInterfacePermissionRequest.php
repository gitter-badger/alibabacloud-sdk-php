...
class CreateNetworkInterfacePermissionRequest extends \AlibabaCloud\Core\RpcRequest {
	...
	public function setAccountId($accountId) {
		...
		$this->apiParameters['AccountId'] = $accountId;
	}
	...
	public function setPermission($permission) {
		...
		$this->apiParameters['Permission'] = $permission;
	}
