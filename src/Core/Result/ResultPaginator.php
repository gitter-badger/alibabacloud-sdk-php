...
{
    /** @var AlibabaCloudClientInterface Client performing operations. */
    private $client;
    ...
    /**
     * @param AlibabaCloudClientInterface $client
     * @param string             $operation
     * @param array              $args
     * @param array              $config
     */
    public function __construct(
        AlibabaCloudClientInterface $client,
        $operation,
        array $args,
        array $config
    ) {
     ...
     *
     * The callback should have the signature: function (AlibabaCloud\Result $result).
