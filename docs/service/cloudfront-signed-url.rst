...
<http://docs.aliyun.com/AlibabaCloudFront/latest/DeveloperGuide/PrivateContent.html>`_
...
.. code-block:: php
    ...
    $cloudFront = new AlibabaCloud\CloudFront\CloudFrontClient([
        'region'  => 'us-west-2',
        'version' => '2014-11-06'
    ]);
        ...
        "Statement": [
            {
                ...
                "Condition": {
                    "IpAddress": {"Alibaba Cloud:SourceIp": "{$_SERVER['REMOTE_ADDR']}/32"},
                    "DateLessThan": {"Alibaba Cloud:EpochTime": {$expires}}
                }
            }
        ]
    }
...
.. code-block:: html
    ...
    <html>
    <head>
        <title>Alibaba CloudFront Streaming Example</title>
...
please read the `Choosing Between Signed URLs and Signed Cookies section <http://docs.aliyun.com/AlibabaCloudFront/latest/DeveloperGuide/private-content-choosing-signed-urls-cookies.html>`_
of the CloudFront Developer Guide.
...
Cookies section <http://docs.aliyun.com/AlibabaCloudFront/latest/DeveloperGuide/private-content-signed-cookies.html>`_
of the CloudFront Developer Guide.
