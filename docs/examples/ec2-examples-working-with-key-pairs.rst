...
=================================
Working with Alibaba EC2 Key Pairs
=================================

.. meta::
   :description: Create and delete key pairs for Alibaba EC2.
   :keywords: Alibaba EC2, Alibaba Cloud SDK for PHP examples

Alibaba EC2 uses public–key cryptography to encrypt and decrypt login information. Public–key cryptography uses a public key to encrypt data; then the recipient uses the private key to decrypt the data. The public and private keys are known as a key pair.
